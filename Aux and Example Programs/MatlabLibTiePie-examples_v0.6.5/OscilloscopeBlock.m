...
addpath ('C:\software\TiePie\Hydrophone_Code\+LibTiePie');
addpath ('C:\software\TiePie\Hydrophone_Code\libtiepie-0.7.6.WindowsNT-x86-64');
addpath ('C:\software\TiePie\Hydrophone_Code\libtiepie-0.7.6.WindowsNT-x86-64\C');
addpath ('C:\software\TiePie\Hydrophone_Code\libtiepie-0.7.6.WindowsNT-x86-64\C++');
addpath ('C:\software\TiePie\Hydrophone_Code\libtiepie-0.7.6.WindowsNT-x86-64\Pascal');
...
if exist('scp', 'var')
    ...
    chTr = scp.Channels(2).Trigger; % Ch 1
